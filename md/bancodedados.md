...
## 22. tabela de agendamento de consulta para não utentes

create table agendamento (
    id_userAgen int auto_increment primary key,
    nome_completo varchar(100) not null,
    email varchar(255) unique not null,
    data_consulta timestamp default true,
    telefone varchar(20),
    especialidade enum('Cardiologia', 'Pediatria', 'Dermatologia', 'Ortopedia', 'Genicologia', 'Clínica Geral', 'Neurologia'),
    horario_preferencial
);

## 23. tabela de administradores
